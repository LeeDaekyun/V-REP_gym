...
from UR5env import UR5env

parser = argparse.ArgumentParser(description='PyTorch Soft Actor-Critic Args')
parser.add_argument('--env-name', default="UR5_vrep",
                    help='gym custom environment with UR5 vrep simulator')
...
env = UR5env(sim_client, terminalstep=2000, threshold=0.005, _max_episode_steps=10, objfilepath='VrepGYM/blocks')
...
for i_episode in itertools.count(1):
    ...
    if i_episode % 10 == 0:
        agent.save_model(env_name='UR5_vrep')
#env.close()
